...
/**
 *  Η συγκεκριμένη κλάση υλοποιεί τον αλγόριθμος "BestFit" .
...
public class BestFit extends MemoryAllocationAlgorithm {
     ...
     * διεργασία που αναλύουμε χρησιμοποιώντας τον αλγόριθμος "BestFit" .
     ...
     * μια προσπέλαση  του πίνακα συγκρίνωντας τα περιεχόμενά του με το MemoryRequirements
